...
public class BookPackage extends JFrame implements ActionListener {
    ...
    BookPackage(String username) {
        ...
        // Initialize Book Package button as disabled
    ...
    if (ae.getSource() == checkprice) {
        // Validate if the total persons is a valid integer greater than 0
        try {
            int persons = Integer.parseInt(tfpersons.getText());
            if (persons > 0) {
                // If valid, proceed with price calculation
                Conn c = new Conn();
                ...
                while (rs.next()) {
                    ...
                    // Enable Book Package button after valid price calculation
                    bookpackage.setEnabled(true);
                }
            } else {
                // If not valid, display error message and disable Book Package button
        ...
        // Book Package button clicked, proceed with booking
        try {
            Conn c = new Conn();
        ...
        // Back button clicked, navigate back
        setVisible(false);
        new Package_Hotel("");
    }
}
