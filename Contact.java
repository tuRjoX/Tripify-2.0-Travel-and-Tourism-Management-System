        ...
        btn1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    String comment = emptyArea.getText();

                    // Name validation
                    if (name.trim().isEmpty()) {
                        JOptionPane.showMessageDialog(d, "Please enter your name.");
                        return;
                    }
                    ...
                    Conn c = new Conn();
                    String query = "insert into contacts values ('" + name + "', '" + email + "', '" + comment + "')";
